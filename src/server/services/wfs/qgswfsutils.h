...
namespace QgsWfs
{
   ...
   */
  QgsFeatureRequest parseFilterElement( const QString &typeName, QDomElement &filterElem, const QgsWfsParameters &wfsParameters, const QgsProject *project = nullptr );

  /**
   * Transform a Filter element to a feature request and update server feature ids
   */
  QgsFeatureRequest parseFilterElement( const QString &typeName, QDomElement &filterElem, QStringList &serverFids, const QgsWfsParameters &wfsParameters, const QgsProject *project = nullptr, const QgsMapLayer *layer = nullptr );
