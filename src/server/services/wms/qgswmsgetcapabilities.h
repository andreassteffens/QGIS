...
namespace QgsWms
{
  ...
  QDomElement getLayersAndStylesCapabilitiesElement( QDomDocument &doc,
      ...
      const QgsProject *project, const QgsServerRequest &request,
   ...
   */
  QDomDocument getCapabilities( QgsServerInterface *serverIface, const QgsProject *project, const QString &version, const QgsWmsRequest &request,
                                bool projectSettings );
