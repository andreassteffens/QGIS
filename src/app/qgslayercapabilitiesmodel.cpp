  ...
  : QSortFilterProxyModel( parent )
{
  ...
  for ( QMap<QString, QgsMapLayer *>::const_iterator it = mapLayers.constBegin(); it != mapLayers.constEnd(); ++it )
  {
    ...
    mSbNavigableLayers.insert( it.value(), it.value()->type() == Qgis::LayerType::Vector && bNavigable );
    ...
    mSbSelectableLayers.insert( it.value(), it.value()->type() == Qgis::LayerType::Vector && bSelectable );
    ...
    mSbSnappableLayers.insert( it.value(), it.value()->type() == Qgis::LayerType::Vector && bSnappable );
  }
}
