...
bool QgsPostgresFeatureIterator::declareCursor(const QString &whereClause, long limit, bool closeOnFail, const QString &orderBy)
{
	...
	if (mRequest.sbQuerySubstitutions().count() > 0 && mRequest.sbQuerySubstitutions().count() < 10)
	{
		switch (mRequest.sbQuerySubstitutions().count())
		{
		case 1:
			query = query.arg(mRequest.sbQuerySubstitutions()[0]);
			break;
		case 2:
			query = query.arg(mRequest.sbQuerySubstitutions()[0], mRequest.sbQuerySubstitutions()[1]);
			break;
		case 3:
			query = query.arg(mRequest.sbQuerySubstitutions()[0], mRequest.sbQuerySubstitutions()[1], mRequest.sbQuerySubstitutions()[2]);
			break;
		case 4:
			query = query.arg(mRequest.sbQuerySubstitutions()[0], mRequest.sbQuerySubstitutions()[1], mRequest.sbQuerySubstitutions()[2], mRequest.sbQuerySubstitutions()[3]);
			break;
		case 5:
			query = query.arg(mRequest.sbQuerySubstitutions()[0], mRequest.sbQuerySubstitutions()[1], mRequest.sbQuerySubstitutions()[2], mRequest.sbQuerySubstitutions()[3], mRequest.sbQuerySubstitutions()[4]);
			break;
		case 6:
			query = query.arg(mRequest.sbQuerySubstitutions()[0], mRequest.sbQuerySubstitutions()[1], mRequest.sbQuerySubstitutions()[2], mRequest.sbQuerySubstitutions()[3], mRequest.sbQuerySubstitutions()[4], mRequest.sbQuerySubstitutions()[5]);
			break;
		case 7:
			query = query.arg(mRequest.sbQuerySubstitutions()[0], mRequest.sbQuerySubstitutions()[1], mRequest.sbQuerySubstitutions()[2], mRequest.sbQuerySubstitutions()[3], mRequest.sbQuerySubstitutions()[4], mRequest.sbQuerySubstitutions()[5], mRequest.sbQuerySubstitutions()[6]);
			break;
		case 8:
			query = query.arg(mRequest.sbQuerySubstitutions()[0], mRequest.sbQuerySubstitutions()[1], mRequest.sbQuerySubstitutions()[2], mRequest.sbQuerySubstitutions()[3], mRequest.sbQuerySubstitutions()[4], mRequest.sbQuerySubstitutions()[5], mRequest.sbQuerySubstitutions()[6], mRequest.sbQuerySubstitutions()[7]);
			break;
		case 9:
			query = query.arg(mRequest.sbQuerySubstitutions()[0], mRequest.sbQuerySubstitutions()[1], mRequest.sbQuerySubstitutions()[2], mRequest.sbQuerySubstitutions()[3], mRequest.sbQuerySubstitutions()[4], mRequest.sbQuerySubstitutions()[5], mRequest.sbQuerySubstitutions()[6], mRequest.sbQuerySubstitutions()[7], mRequest.sbQuerySubstitutions()[8]);
			break;
		}
